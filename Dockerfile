...
RUN Rscript -e 'remotes::install_version("thinkr",upgrade="never", version = "0.13")'
...
RUN Rscript -e 'remotes::install_version("covr",upgrade="never", version = "3.5.0")'
RUN Rscript -e 'remotes::install_github("ThinkR-open/shinytemplate@5fa9a92e2863c443cdbcd6d477ab97c6db717f79")'
RUN mkdir /build_zone
ADD . /build_zone
WORKDIR /build_zone
RUN R -e 'remotes::install_local(upgrade="never")'
EXPOSE 80
CMD R -e "options('shiny.port'=80,shiny.host='0.0.0.0');shinyapp::run_app()"
